...
[image: Build status][image][image][image: Latest version on
PyPI][image][image: License][image]
...
Note:
  ...
  temporarily disabled until we can retrain the models.
...
with Ian Cordasco’s charade fork, so now we have one coherent version
